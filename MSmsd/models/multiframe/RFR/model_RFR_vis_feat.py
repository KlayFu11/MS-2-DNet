...
from deepmist.models.multiframe.RFR.ResUNet.model_ResUNet_vis_feat import ResUNet
...
class RFR_vis_feat(nn.Module):
    def __init__(self,
                 mid_channels=16,
                 head_name='ResUNet'):

        super(RFR_vis_feat, self).__init__()
    ...
    def forward(self, lqs):
        ...
        fea = self.fusion(fea)
        out, z_4, z_3, z_2, z_1 = self.detection_head(fea)
        return out, z_4, z_3, z_2, z_1
...
if __name__ == '__main__':
    model = RFR_vis_feat(head_name='ResUNet').cuda()
