...
from deepmist.models.multiframe.RFR.dcn.functions.modulated_deform_conv_func import ModulatedDeformConvFunction
...
class ModulatedDeformConvPack(ModulatedDeformConv):
    ...
    def __init__(self, in_channels, out_channels,
        ...
        self.init_offset()
        self.max_residual_magnitude = 20

    def init_offset(self):
        constant_init(self.conv_offset_mask[-1], val=0, bias=0)
