...
def parse_args():
    ...
    parser.add_argument('--datapath', type=str, default='/home/ubuntu/data/zhengqinxu/object_detection/DATA/MIST_0912')
    parser.add_argument('--dataset', type=str, default='MIST', help='dataset name [default: NUDT-MIRSDT, RGB-T]')
    parser.add_argument('--log_dir', type=str, default=None, help='Log path [default: None]')
    parser.add_argument('--savepath', type=str, default='./log/', help='Save path [default: ./log/]')
    parser.add_argument('--decay_rate', type=float, default=1e-4, help='weight decay [default: 1e-4]')
    parser.add_argument('--seqlen', type=int, default=5, help='Frame number as an input [default: 100]')
