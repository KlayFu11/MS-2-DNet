...
from deepmist.models.multiframe.DeepPro.networks.layers.basic import TD_Resblock, STD_Resblock
from deepmist.models.multiframe.DeepPro.networks.layers.basic import TDifferenceConv, SDifferenceConv
from deepmist.models.multiframe.DeepPro.networks.layers.TPro import TPro
from deepmist.models.multiframe.DeepPro.networks.losses.HAM_loss_MultiFrame import HAM_loss
from deepmist.models.multiframe.DeepPro.networks.losses.HPM_loss_MultiFrame import HPM_loss
...
if __name__ == '__main__':
    ...
    model = DeepPro(num_classes=1, seqlen=5, out_len=5).cuda()
