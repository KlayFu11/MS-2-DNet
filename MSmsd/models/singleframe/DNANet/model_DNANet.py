...
if __name__ == '__main__':
    # model = DNANet(input_channels=1).cuda()
    # inputs = torch.randn((20, 1, 256, 256)).cuda()  # Params = 4.7M FLOPs = 285.16G

    model = DNANet(input_channels=3).cuda()
    inputs = torch.randn((1, 3, 384, 384)).cuda()  # Params = 4.7M FLOPs = 32.13G
