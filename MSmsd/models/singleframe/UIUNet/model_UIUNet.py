...
class UIUNet(nn.Module):
    ...
    def __init__(self, in_ch=3, out_ch=1, deep_supervision=True):
...
if __name__ == '__main__':
    # model = UIUNet(in_ch=1).cuda()
    # inputs = torch.randn((20, 1, 256, 256)).cuda()  # Params = 50.54M FLOPs = 1088.51G

    model = UIUNet(in_ch=3).cuda()
    inputs = torch.randn((1, 3, 384, 384)).cuda()  # Params = 50.54M FLOPs = 122.63G
