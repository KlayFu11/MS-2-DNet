...
from deepmist.models.singleframe.FC3Net.FCNHead import _FCNHead
from deepmist.models.singleframe.FC3Net.Basic import FC3BasicBlock
from deepmist.models.singleframe.FC3Net.CFC import CFC_Module
...
if __name__ == '__main__':
    model = FC3().cuda()
    inputs = torch.randn((1, 3, 384, 384)).cuda()  # Params = 6.9M FLOPs = 5.95G
